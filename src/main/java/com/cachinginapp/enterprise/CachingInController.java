...
public class CachingInController {
     ...
     * 409
     *
     * @param cache a JSON representation of a specimen object.
     ...
     * @return message confirming the cache was removed. TODO: create a message that confrims the cache was removed.
     */
